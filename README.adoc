...
Si oui, on cherche dans commandes si le nom d'une ligne est égale au nom de la boxe sélectionnée, si oui on augmante la quantité de un, on recalcule le prix totale de la ligne (suivi d'une commande qui évite un bug d'affichage du prix). +
