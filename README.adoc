...
-Dans un contexte en ligne, la collecte des données (ici le nom du client) est utilisée afin que quand le client soit identifié lorsqu'il vient chercher et payer sa commande. +
